...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(/*name*/ ctx[0]);
    			attr_dev(h1, "id", "name");
    			attr_dev(h1, "class", "flex-basis-100 margin-tb svelte-1uhg8ak");
    			add_location(h1, file$2, 34, 6, 772);
    		},
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "svelte-1uhg8ak");
    			add_location(span, file$2, 31, 14, 713);
    			attr_dev(h1, "id", "name");
    			attr_dev(h1, "class", "flex-basis-100 margin-tb svelte-1uhg8ak");
    			add_location(h1, file$2, 30, 6, 651);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			append_dev(h1, t0);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p0, "class", "flex-basis-100 margin-tb svelte-1uhg8ak");
    			add_location(p0, file$2, 36, 4, 845);
    			attr_dev(p1, "id", "quantity");
    			attr_dev(p1, "class", "flex-basis-100 margin-tb svelte-1uhg8ak");
    			add_location(p1, file$2, 37, 4, 920);
    			add_location(span, file$2, 28, 2, 614);
    			if (!src_url_equal(img.src, img_src_value = /*image_url*/ ctx[4])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", /*description*/ ctx[1]);
    			attr_dev(img, "class", "margin-tb svelte-1uhg8ak");
    			attr_dev(img, "width", "364");
    			attr_dev(img, "height", "274");
    			set_style(img, "margin", /*image_margin*/ ctx[6] + "px 50%");
    			add_location(img, file$2, 41, 2, 1019);
    			attr_dev(div, "class", "svelte-1uhg8ak");
    			add_location(div, file$2, 27, 0, 606);
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	function updateRotation() {
    		...
    		if (rotation % 2 === 0) {
    			$$invalidate(6, image_margin = 0);
    		} else {
    			$$invalidate(6, image_margin = (image.width - image.height) / 2);
    		}
    	}
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('rotation' in $$props) $$invalidate(7, rotation = $$props.rotation);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('image_margin' in $$props) $$invalidate(6, image_margin = $$props.image_margin);
    	};
