...
var app = (function () {
    ...
    function create_each_block(ctx) {
    	...
    	item = new Item({
    			props: {
    				name: /*item*/ ctx[2].name,
    				description: /*item*/ ctx[2].description,
    				quantity: /*item*/ ctx[2].quantity,
    				image_url: "https://tech-catalog-images.s3.us-west-1.amazonaws.com/" + /*item*/ ctx[2].key + ".png"
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const item_changes = {};
    			if (dirty & /*items*/ 1) item_changes.name = /*item*/ ctx[2].name;
    			if (dirty & /*items*/ 1) item_changes.description = /*item*/ ctx[2].description;
    			if (dirty & /*items*/ 1) item_changes.quantity = /*item*/ ctx[2].quantity;
    			if (dirty & /*items*/ 1) item_changes.image_url = "https://tech-catalog-images.s3.us-west-1.amazonaws.com/" + /*item*/ ctx[2].key + ".png";
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(45:1) {#each items as item}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-19nd8ua");
