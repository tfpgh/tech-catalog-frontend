...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p1 = element("p");
    			t4 = text("Quantity: ");
    			t5 = text(/*quantity*/ ctx[2]);
    			t6 = space();
    			img = element("img");
    			attr_dev(h1, "id", "name");
    			attr_dev(h1, "class", "svelte-ih2g50");
    			add_location(h1, file$2, 8, 4, 222);
    			attr_dev(p0, "id", "description");
    			attr_dev(p0, "class", "svelte-ih2g50");
    			add_location(p0, file$2, 9, 4, 253);
    			attr_dev(p1, "id", "quantity");
    			attr_dev(p1, "class", "svelte-ih2g50");
    			add_location(p1, file$2, 10, 4, 296);
    			if (!src_url_equal(img.src, img_src_value = /*image_url*/ ctx[3])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", /*description*/ ctx[1]);
    			attr_dev(img, "class", "svelte-ih2g50");
    			add_location(img, file$2, 11, 4, 343);
    			attr_dev(div, "class", "svelte-ih2g50");
    			add_location(div, file$2, 7, 0, 211);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*quantity*/ 4) set_data_dev(t5, /*quantity*/ ctx[2]);

    			if (dirty & /*image_url*/ 8 && !src_url_equal(img.src, img_src_value = /*image_url*/ ctx[3])) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['name', 'description', 'quantity', 'image_url'];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('image_url' in $$props) $$invalidate(3, image_url = $$props.image_url);
    	};

    	$$self.$capture_state = () => ({ name, description, quantity, image_url });
    	...
    	return [name, description, quantity, image_url];
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 5, 0, 82);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (58:2) {#each categories as category}
    function create_each_block_1(ctx) {
    	let category;
    	let current;

    	function click_handler() {
    		return /*click_handler*/ ctx[3](/*category*/ ctx[7]);
    	}

    	category = new Category({
    			props: {
    				name: /*category*/ ctx[7],
    				active: /*shown_category*/ ctx[1] === /*category*/ ctx[7].toLowerCase()
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*categories*/ 4) category_changes.name = /*category*/ ctx[7];
    			if (dirty & /*shown_category, categories*/ 6) category_changes.active = /*shown_category*/ ctx[1] === /*category*/ ctx[7].toLowerCase();
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(58:2) {#each categories as category}",
    		ctx
    	});
    ...
    // (68:3) {#if item.categories.includes(shown_category)}
    function create_if_block(ctx) {
    	...
    	item = new Item({
    			props: {
    				name: /*item*/ ctx[4].name,
    				description: /*item*/ ctx[4].description,
    				quantity: /*item*/ ctx[4].quantity,
    				image_url: "https://tech-catalog-images.s3.us-west-1.amazonaws.com/" + /*item*/ ctx[4].key + ".png"
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const item_changes = {};
    			if (dirty & /*items*/ 1) item_changes.name = /*item*/ ctx[4].name;
    			if (dirty & /*items*/ 1) item_changes.description = /*item*/ ctx[4].description;
    			if (dirty & /*items*/ 1) item_changes.quantity = /*item*/ ctx[4].quantity;
    			if (dirty & /*items*/ 1) item_changes.image_url = "https://tech-catalog-images.s3.us-west-1.amazonaws.com/" + /*item*/ ctx[4].key + ".png";
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(68:3) {#if item.categories.includes(shown_category)}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	let show_if = /*item*/ ctx[4].categories.includes(/*shown_category*/ ctx[1]);
    	let if_block_anchor;
    	let current;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*items, shown_category*/ 3) show_if = /*item*/ ctx[4].categories.includes(/*shown_category*/ ctx[1]);

    			if (show_if) {
    				if (if_block) {
    					if_block.p(ctx, dirty);

    					if (dirty & /*items, shown_category*/ 3) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(67:2) {#each items as item}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*categories, shown_category*/ 6) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const click_handler = category => $$invalidate(1, shown_category = category.toLowerCase());
    	...
    	$$self.$inject_state = $$props => {
    		if ('shown_category' in $$props) $$invalidate(1, shown_category = $$props.shown_category);
    		...
    		if ($$self.$$.dirty & /*items*/ 1) {
    			{
    				...
    				$$invalidate(2, categories = generating_categories);
    			}
    		}
    	};

    	return [items, shown_category, categories, click_handler];
    }
