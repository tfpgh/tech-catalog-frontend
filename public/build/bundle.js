...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			img = element("img");
    			attr_dev(h1, "id", "name");
    			attr_dev(h1, "class", "svelte-by6qgm");
    			add_location(h1, file$3, 8, 4, 214);
    			attr_dev(p0, "id", "description");
    			attr_dev(p0, "class", "svelte-by6qgm");
    			add_location(p0, file$3, 9, 4, 244);
    			attr_dev(p1, "id", "quantity");
    			attr_dev(p1, "class", "svelte-by6qgm");
    			add_location(p1, file$3, 10, 4, 286);
    			if (!src_url_equal(img.src, img_src_value = /*image_url*/ ctx[3])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", /*description*/ ctx[1]);
    			attr_dev(img, "class", "svelte-by6qgm");
    			add_location(img, file$3, 11, 4, 332);
    			attr_dev(div, "class", "svelte-by6qgm");
    			add_location(div, file$3, 7, 0, 204);
    		},
    ...
    class Category extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*name*/ ctx[0] === undefined && !('name' in props)) {
    			console.warn("<Category> was created without expected prop 'name'");
    		}
    	}
    ...
    // (8:4) {#each categories as category}
    function create_each_block$1(ctx) {
    	let category;
    	let current;

    	category = new Category({
    			props: { name: /*category*/ ctx[1] },
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*categories*/ 1) category_changes.name = /*category*/ ctx[1];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(8:4) {#each categories as category}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "svelte-14n9wzy");
    			add_location(div, file$1, 6, 0, 104);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Category, categories });
    ...
    class NavBar extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { categories: 0 });
    ...
    function create_each_block(ctx) {
    	...
    	const item_spread_levels = [
    		/*item*/ ctx[1],
    		{
    			image_url: "https://tech-catalog-images.s3.us-west-1.amazonaws.com/" + /*item*/ ctx[1].key + ".png"
    		}
    	];
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-rwjcgw");
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Item, NavBar, onMount, items });
